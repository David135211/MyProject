...
#define	NSA3000_SYNC_INTERVAL	60*20			/* 对时间隔  单位s*/
...
//			BYTE byNum = *pData;
			pData ++;
			WORD wValue = MAKEWORD(*pData, *(pData+1));				//低--高
			for(int j = 0; j<16; j++)
			{
