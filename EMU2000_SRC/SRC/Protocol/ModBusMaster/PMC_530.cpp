...
{/*{{{*/
	...
	m_pMethod->SetYmData(m_SerialNo, 0, valuebridge[0]);
	m_pMethod->SetYmData(m_SerialNo, 1, valuebridge[3]);
	m_pMethod->SetYmData(m_SerialNo, 2, valuebridge[1]);
	m_pMethod->SetYmData(m_SerialNo, 3, valuebridge[2]);
}/*}}}*/
