...
#define  MODULE_ESD_MODBUS_SLAVE			1 //ESD标准模块
#define  MODULE_SULTAN_MODBUS_SLAVE		2 //针对南苏丹模块
...
{
	CProtocol_ModBusSlave * pProtocol = NULL ;
...
BOOL CProtocol_ModBusSlave::InitMS_Module( CProtocol_ModBusSlave * pProtocol , int iModule , char * sMasterAddr , WORD iAddr , char * sName , char * stplatePath )
{
	if( pProtocol == NULL )
		return FALSE ;
