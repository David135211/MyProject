#ifndef CSWITCH_CONNECT_EARTH_H
#define CSWITCH_CONNECT_EARTH_H

#include "ceelment.h"

class CSwitch_connect_earth : public CElement
{
    Q_OBJECT
public:
    CSwitch_connect_earth();
