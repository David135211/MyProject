...
BOOL CSwitch_3pos::DrawElemnt( QPainter *pPainter )
{
    if( !pPainter )
    {
        Q_ASSERT( FALSE );
...
BOOL CSwitch_3pos::Create( QRect rc )
{
    m_rcDraw = rc ;
    return TRUE ;
}

void CSwitch_3pos::CreateMenu()
{
...
void CSwitch_3pos::DrawVertical( QPainter *pPainter )
{
...
void CSwitch_3pos::DrawVerticalTop( QPainter * pPainter )
{
    if( !pPainter || m_rcDraw.isNull() )
    {
        Q_ASSERT( FALSE ) ;
...
void CSwitch_3pos::DrawVerticalBottom( QPainter * pPainter )
{
    if( !pPainter || m_rcDraw.isNull() )
    {
        Q_ASSERT( FALSE ) ;
...
void CSwitch_3pos::DrawHorizontal( QPainter *pPainter )
{
    if( !pPainter || m_rcDraw.isNull() )
    {
        Q_ASSERT( FALSE ) ;
...
void CSwitch_3pos::DrawHorizontalTop( QPainter * pPainter )
{
    if( !pPainter || m_rcDraw.isNull() )
    {
        Q_ASSERT( FALSE ) ;
...
void CSwitch_3pos::DrawHorizontalBottom( QPainter * pPainter )
{
    if( !pPainter || m_rcDraw.isNull() )
    {
        Q_ASSERT( FALSE ) ;
...
void CSwitch_3pos::DrawIsChoice( QPainter * pPainter )
{
    if( m_byIsChoice )
    {
        pPainter->save();
...
BOOL CSwitch_3pos::CompareAttributeData( )
{
...
BOOL CSwitch_3pos::ProcessMouseDown( QMouseEvent * pEvent )
{
    m_byIsChoice = TRUE;
...
void CSwitch_3pos::slots_QMenuAction(QAction * action)
{
    if( action == NULL )
        return;
...
void CSwitch_3pos::SetAction(BYTE Action, BYTE CurStatus)
{
//    WORD wBusNoDst = -1;
//    WORD wDevAddrDst = -1;
//    WORD wPntDst = -1;
...
BOOL CSwitch_3pos::IsChangeColor( )
{
...
BOOL CSwitch_3pos::SetChangeNodeColor(WORD ChangeNode, BYTE PowerState)
{
    m_byLeftTopPower = POWER_OFF;
    m_byRightBottomPower = POWER_OFF;
